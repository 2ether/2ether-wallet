...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `GAS limite` * le `prix du GAS`. [Vous pouvez convertir GWEI -> ETH ici.](https://wallet.2ether.com/helpers.html)',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Ceci vous permet de télécharger plusieurs versions des clefs privées et d\'imprimer votre portefeuille papier. Vous devrez le faire pour [importer votre compte dans Geth / Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Si vous voulez seulement consulter votre solde, nous recommandons d\'utiliser un explorateur de blockchain comme [explorer.2ether.com](https://explorer.2ether.com).',
...
ERROR_35                    : '(error_36) Input address is not checksummed. <a href="https://kb.wallet.2ether.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer">What does that mean?</a> L\'adresse d\'entrée n\'a pas de somme de contrôle. <a href="https://kb.wallet.2ether.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener">Cliquez ici pour plus d\'infos</a>.',
...
GETH_Balance                : '(geth-01) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Solde insuffisant',
...
GETH_GasLimit               : '(geth-03) Exceeds block gas limit. Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html). Limite de Gas dépassée',
GETH_InsufficientFunds      : '(geth-04) Insufficient balance. Your gas limit * gas price + amount to send exceeds your current balance. Send more ETH to your account or use the "Send Entire Balance" button. If you believe this is in error, try pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants pour (Gas * prix) + valeur',
...
GETH_Nonce                  : '(geth-08) This TX\'s [nonce](https://kb.wallet.2ether.com/transactions/what-is-nonce.html) is too low. Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html). Nonce trop bas',
...
PARITY_AlreadyImported      : "(parity-01) A transaction with the same hash was already imported. It was probably already broadcast. To avoid duplicate transactions, check your address on [etherscan.io](https://etherscan.io) & wait 10 minutes before attempting to send again. [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Une transaction portant la même empreinte (_hash_) a déjà été importée.",
PARITY_GasLimitExceeded     : "(parity-02) Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html). Le coût de la transaction excède la limite en Gas courante (limite : {}, coût : {}). Essayez de réduire le Gas fourni.",
PARITY_InsufficientBalance  : "(parity-03) Insufficient balance. The account you tried to send transaction from does not have enough funds. If you believe this is in error, try using the 'Send Entire Balance' button, or pressing generate again. Required (d+) and got: (d+). [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Fonds insuffisants. Le compte d'où vous essayez d'envoyer une transaction ne possède pas assez de fonds (requis : {}, disponibles : {}).",
PARITY_InsufficientGasPrice : "(parity-04) There is another transaction with same nonce in the queue, or the transaction fee is too low. Try incrementing the nonce by clicking the Generate button again. [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Les frais de transaction sont trop bas. Ils ne satisfont pas au minimum de votre nœud (minimum : {}, frais : {}). Essayez d\'augmenter les frais.",
PARITY_InvalidGasLimit      : "(parity-05) Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html). Le Gas fourni dépasse la limite.",
PARITY_LimitReached         : "(parity-06) There are too many transactions in the queue. Your transaction was dropped due to limit. Try increasing the gas price. [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Il y a trop de transactions en file d\'attente. Votre transaction a été abandonnée en raison de cette limite. Essayez d\'augmenter les frais.",
PARITY_Old                  : "(parity-07) There is already a transaction with this [nonce](https://kb.wallet.2ether.com/transactions/what-is-nonce.html). Try incrementing the nonce by pressing the Generate button again, or [replace the pending transaction](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html). Le nonce de la transaction est trop bas. Essayez d\'incrémenter le nonce.",
PARITY_TooCheapToReplace    : "(parity-08) TX Fee is too low. It does not satisfy your node's minimal fee (minimal: (d+), got: (d+)). Try increasing the gas price and/or gas limit. [Learn More.](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html). Les frais de transaction sont trop bas. Il y a une autre transaction avec le même nonce en file d\'attente. Essayez d\'augmenter les frais ou d\'incrémenter le nonce.",

/* Tranlsation Info */
translate_version           : '0.4',
Translator_Desc             : 'Merci à nos traducteurs',
TranslatorName_1            : '[Simon P](https://wallet.2ether.com/?gaslimit=21000&to=0x89a18eE46b5aabC62e94b1830881887D04C687f3&value=1.0#send-transaction) ·',
...
HELP_Desc                   : 'Il manque quelque chose ? Vous avez d\'autres questions ? [Contactez-nous](mailto:support@wallet.2ether.com), et non seulement nous allons vous répondre, mais nous mettrons aussi à jour cette page afin qu\'elle soit plus utile à tout le monde à l\'avenir !',
HELP_Remind_Title           : 'Quelques rappels :',
HELP_Remind_Desc_1          : '**Ethereum, wallet.2ether.com & MyEtherWallet CX, ainsi que certaines des bibliothèques Javascript que nous employons sont en cours de développement.** Bien que nous les ayons testés intensivement et que des dizaines de milliers de portefeuilles aient été créés avec succès dans le monde entier, il existe toujours une faible possibilité qu\'un incident se produise, conduisant à la perte de vos ethers. N\'investissez pas plus que ce que vous pouvez vous permettre de perdre, et restez toujours prudents. En cas d\'accident, nous en serons désolés mais **nous ne sommes pas responsables d\'une éventuelle perte d\'ether**.',
HELP_Remind_Desc_2          : 'wallet.2ether.com & MyEtherWallet CX ne sont pas des "portefeuilles web". Vous ne créez pas un compte, vous ne déposez pas votre ether chez nous. Aucune donnée ne sort de votre ordinateur ou de votre navigateur. Nous vous facilitons la création, la sauvegarde et l\'accès à vos informations ainsi que l\'interaction avec le blockchain.',
...
HELP_3_Desc_3               : 'Naviguez vers la page Visualisation d\'un portefeuille" de wallet.2ether.com.',
...
HELP_5_Title                : '5) Comment puis-je lancer wallet.2ether.com hors ligne (en local) ?',
HELP_5_Desc_1               : 'Vous pouvez lancer wallet.2ether.com sur votre ordinateur au lieu de passer par les serveurs GitHub. Vous pouvez générer un portefeuille en restant totalement hors ligne et envoyer des transactions depuis la page "Transaction hors ligne".',
HELP_5_Desc_7               : 'wallet.2ether.com tourne maintenant complètement sur votre ordinateur.',
...
HELP_5_Desc_9               : 'Comme nous améliorons constamment wallet.2ether.com, nous vous recommandons de mettre régulièrement à jour votre version de sauvegarde.',
...
HELP_SecCX_Desc_6           : 'Si nous devions chiffrer ces informations, il vous faudrait entrer un mot de passe à chaque fois que vous voudriez voir votre solde ou les surnoms. Si cela vous ennuie, nous vous recommandons d\'utiliser wallet.2ether.com au lieu de cette extension Chrome.',
...
HELP_Sec_Desc_4             : 'Vérifiez l\'URL -- Ce site est servi par Github (et vous pouvez en voir le code source ici : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages)) vers [https://wallet.2ether.com](https://wallet.2ether.com).',
