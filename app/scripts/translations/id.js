...
/* Onboarding */
ONBOARD_welcome_title           :  'Selamat datang di wallet.2ether.com',
...
ONBOARD_blockchain_content__5   :  'Saat Anda melihat saldo di wallet.2ether.com atau melihat transaksi Anda di [etherscan.io](https://etherscan.io), Anda melihat data di blockchain, bukan di sistem privat Anda.',
...
ONBOARD_whymew_content__6       :  'Jika Anda takut tapi ingin menggunakan MEW, [gunakan dompet hardware](https://kb.wallet.2ether.com/hardware-wallets/hardware-wallet-recommendations.html)! Perangkat ini akan menjaga kunci Anda tetap aman.',
...
ONBOARD_secure_1_content__3     :  'Selalu periksa URLnya: `https://wallet.2ether.com`.',
...
ONBOARD_secure_3_content__6     :  '[Lihat lebih banyak lagi tentang Tips Keamanan!](https://kb.wallet.2ether.com/getting-started/protecting-yourself-and-your-funds.html)',
...
TXFEE_Desc                  : 'Biaya TX Fee dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Jumlahnya =  `gas limit` * `gas price`. [Anda dapat mengkonversi GWEI -> ETH](https://wallet.2ether.com/helpers.html)',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'Memungkinkan Anda untuk mencetak Dompet Kertas dari berbagai format atau versi Kunci Privat. Hal ini diperlukan pada saat anda ingin [mengimpor akun Anda ke Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). Jika Anda hanya ingin pengecekan saldo, pakailah salah satu layanan blockchain explorer seperti [explorer.2ether.com](https://explorer.2ether.com). ',
...
NODE_Warning                : 'Node Anda harus berupa HTTPS untuk dapat terhubung melalui wallet.2ether.com. Anda dapat [mengunduh MyEtherWallet repo & menjalankannya secara lokal](https://github.com/kvhnuke/etherwallet/releases/latest) untuk terhubung ke node apa saja. Atau, dapatkan SSL certificate gratis melalui [LetsEncrypt](https://letsencrypt.org/)',
NODE_Name                   : 'Nama Node',
NODE_Port                   : 'Port Node',
...
ERROR_28                    : '**DIPERLUKAN File Keystore & password** (atau Kunci Privat) untuk mengakses dompet Anda. Simpan dan backup dengan baik file ini! Tidak ada mekanisme untuk me-recover dompet jika file-nya hilang. Baca instruksi lengkapnya [di sini](https://wallet.2ether.com/#help). ',
...
ERROR_35                    : 'Address yang dimasukkan tidak di checksum. <a href="https://kb.wallet.2ether.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer"> Informasi lebih lanjut</a>', // 35
...
PARITY_InvalidGasLimit      : "(parity-05) Gas yang disediakan nilainya diatas limit. Supplied gas limit is beyond limit. Try lowering the gas limit to 21000. [Learn More.](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html)",
...
TranslatorName_1            : '[Yos Ginting](https://wallet.2ether.com/?gaslimit=21000&to=0x8F646C5c215be6E0163f02Bd2eB97AFC2DF70e5c&value=1.0#send-transaction) ',
...
HELP_Desc                   : 'Anda melihat sesuatu yang hilang? Atau ada pertanyaan lain? [Hubungi kami](mailto:support@wallet.2ether.com), dan kami tidak hanya akan menjawab pertanyaan Anda, kami akan memperbarui halaman ini untuk lebih bermanfaat bagi pengguna lainnya kedepan! ',
HELP_Remind_Title           : 'Beberapa pengingat ',
HELP_Remind_Desc_1          : '** Ethereum, wallet.2ether.com & MyEtherWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas Ether yang hilang**. ',
HELP_Remind_Desc_2          : 'wallet.2ether.com & MyEtherWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan Ether Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_3_Desc_3               : 'Buka laman wallet.2ether.com bagian "Lihat Info Dompet" . ',
...
HELP_5_Title                : '5) Bagaimana cara menjalankan wallet.2ether.com secara offline/lokal? ',
HELP_5_Desc_1               : 'Anda dapat menjalankan wallet.2ether.com secara lokal di komputer Anda, bukan dari server GitHub. Anda dapat membuat dompet yang benar-benar offline dan mengirim transaksi dari laman "Transaksi Offline". ',
HELP_5_Desc_7               : 'wallet.2ether.com sekarang berjalan sepenuhnya di komputer Anda. ',
...
HELP_5_Desc_9               : 'Karena kami masih terus memperbarui wallet.2ether.com, sebaiknya Anda juga memperbarui versi repo yang Anda simpan secara berkala. ',
...
HELP_8_Desc_2               : 'Jika situs wallet.2ether.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" Ether Anda dari wallet.2ether.com karena Ether Anda tidak disimpan di wallet.2ether.com. Ether Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_16_Desc_1              : 'Anda bisa menggunakan eksplorer blockchain seperti [explorer.2ether.com](https://explorer.2ether.com). Paste alamat Anda ke dalam search bar dan riwayat transaksi Anda akan ditampilkan. Contohnya, [akun donasi kami](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) dilihat di etherscan.io ',
...
HELP_SecCX_Desc_6           : 'Jika kami mengenkripsi item ini, Anda harus memasukkan password setiap kali Anda ingin melihat saldo akun atau melihat nickname. Jiak Anda khawatir, kami sarankan Anda menggunakan wallet.2ether.com, bukan Chrome Extension ini. ',
...
HELP_Sec_Desc_4             : 'Periksa URL ini -- Situs ini dijalankan melalui GitHub dan Anda bisa melihat sorce code nya di sini: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) ke [https://wallet.2ether.com](https://wallet.2ether.com). ',
