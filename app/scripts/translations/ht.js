...
tx_Summary                  : 'Pendant des périodes de volume important (comme pendant les ICOs) les transactions peuvent rester en attente des heures, voir des jours. Cet outil cherche à vous donner la possibilité de trouver et "annuler" / remplacer ces transactions. ** Ce n\'est pas quelque chose de possible normalement. Vous ne devriez pas vous y fier et cela ne marchera que lorsque les pools de transactions sont remplis. [Nous vous recommandons d\'en lire plus sur cet outil ici.](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html)**',
...
tx_FoundOnChain_3           : '**Si vous ne voyez pas d\'erreur, votre transaction a été envoyée avec succès.** Vos ETH ou Tokens sont à l\'endroit où vous les avez envoyés. Si vous ne voyez pas ces ETH ou Tokens dans votre autre portefeuille ou compte de place d\'échange, et si cela fait plus de 24 heures, veuillez [contacter ce service](https://kb.wallet.2ether.com/diving-deeper/ethereum-list-of-support-and-communities.html). Envoyez-leur le *lien* vers votre transaction et demandez, poliment, d\'examiner votre situation.',
...
TXFEE_Desc                  : 'Les frais de transaction sont payés aux mineurs pour inclure votre transaction dans un bloc. Cela représente le `gas limit` * le `gas price`. [Vous pouvez convertir GWEI -> ETH ici](https://wallet.2ether.com/helpers.html)',
...
NODE_Warning                : 'NE W’ LA DWE AN HTTPS POU W’ KONEKTE AVÈK wallet.2ether.com. OU KAPAB [PRAN REPO MYWALLET LA EPI OUVRI  L’ LOKALMAN ](https://github.com/kvhnuke/etherwallet/releases/latest) POU W’ KONEKTE A KÈK LÒT NE , OSWA POU W’ GENYEN SÈTIFIKA SSL GRATIS AVÈK[LetsEncrypt](https://letsencrypt.org/).',
NODE_Name                   : 'NON NE A ',
NODE_Port                   : 'PÒ NE A ',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : 'SA PÈMÈT OU POU W’ PRAN PLIZYÈ VÈZSYON KLE SEKRÈ  YO EPI AK SÒTI BOUS OU A ANKÒ SOU PAPYE. OU DWE FÈ L’ POU [ PRAN KONT OU A NAN GETH/MIST] (http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/). SI W’ VLE  WÈ VALÈ KÒB OU A, NOU MANDE W’ POU SÈVI AK YON EKSPLORATÈ POU BLOCKCHAIN TANKOU[explorer.2ether.com](https://explorer.2ether.com).',
...
ERROR_28                    : '**OU BEZWEN PAJ KEYSTORE W’ LA EPI KÒD SEKRÈ A ** ( OSWA KLE SEKRÈ W’ LA) POU KAPAB ANTRE NAN BOUS SA NAN LÒT JOU YO. TANPRI PRAN L’EPI  POU W’ SERE L’ YON KOTE DEYÒ ! PA GEN OKENN LÒT MWAYEN POU W’ JWENN ANKÒ YON BOUS SI W’ PA ANREJISTRE L’. TANPRI LI PAJ SA [PAJ POU EDE](https://wallet.2ether.com/#help) POU DETAY YO ',
...
TranslatorName_1            : '[Nogo10](https://wallet.2ether.com/?gaslimit=21000&to= 0x152e77CC3Dd8d86471ebEa8e93B9924A41e7055a&value=1.0#VOYE-TRANSFÈ A) · ',
...
HELP_Desc                   : 'MANKE YON BAGAY ? SI W’ GEN LÒT KESYON ? [PALE AK NOU]( mailto:support@wallet.2ether.com), N’AP REPONN OU EPI N’AP TOU METE PAJ LA A JOU POU L’ KA ITIL PI PLIS AK TOUT LÒT MOUN YO NAN LÒT JOU YO ! ',
HELP_Remind_Title           : 'KÈK NAN SA POU SONJE YO: ',
HELP_Remind_Desc_1          : 'ETHEREUM, wallet.2ether.com & MYETHER WALLET CX, EPI KÈK NAN BIBLIYOTÈK YO  JAVASCRIPT KI ANBA KE NOU KONN SÈVI AK YO KÒMANSE AP DEVLOPE.** NOU PASE YO GWO TÈS EPI ANPIL DIZÈNN AK MILYE BOUS SA YO TE KREYE AVÈK ANPIL SIKSÈ TOUT KOTE NAN MOND LA. KA TOUJOU GEN YON TI KRAS POSIBLITE KE YON BAGAY KA PASE KI KA PÈMÈT OU PÈDI ETH OU YO. PA ENVESTI PLIS PLIS KE SA W ‘ KA PRÈ POU W’ PÈDI EPI PRIDANS. NAN KA AKSIDAN, N’AP DEZOLE MEN ** NOU P’AP RESPONSAB POU ETHER  SA W’ PÈDI A** ',
HELP_Remind_Desc_2          : 'wallet.2ether.com & MYETHERWALLET CX YO PA "BOUS WEB". OU PA KREYE YON KONT , OU PA BA NOU ETHER W’ YO TANKOU DEPO. OKENN DONE PA SÒTI NAN KOMPITÈ W’ OSWA NAVIGATÈ W’ LA. N’AP FASILITE W’ POU W KREYASYON AN. KIJAN POU KENBE  L’ EPI ANTRE NAN ENFÒMASYON W’ YO AK KONTAK OU MENM AK BLOCKCHAIN NAN. ',
...
HELP_3_Desc_3               : 'NAVIGE AL NAN PAJ  " FÈ PARÈT YON BOUS"  wallet.2ether.com LA. ',
...
HELP_5_Title                : '5) KÒMAN M KA OUVRI wallet.2ether.com SAN SIYAL/LOKAL ? ',
HELP_5_Desc_1               : 'OU KAPAB OUVRI wallet.2ether.com SOU KOMPITÈ W’ LA SAN W’ PA PASE NAN SÈVÈ GITHUB YO. OU KAPAB KREYE YON BOUS SAN OU PA BEZWEN GEN SIYAL EPI VOYE TRANSFÈ YO SÒTI NAN PAJ SA "TRANSFÈ SAN SIYAL". ',
HELP_5_Desc_7               : 'TOUT wallet.2ether.com LA VIRE SOU KOMPITÈ W’ LA KOUNYE A. ',
...
HELP_5_Desc_9               : 'NOU TOUJOU AP AMELYORE wallet.2ether.com, NOU MANDE W’ POU W’ TOUJOU METE A JOU VÈSYON W’ TE KENBE A. ',
...
HELP_8_Desc_2               : 'SI wallet.2ether.com TONBE, OU DWE JWENN YON LÒT MWAYEN ( TANKOU GETH OSWA ETHEREUM WALLET / MIST) POU FÈ MENM BAGAY LA. MEN OU PA GEN POU "REPRAN " ETHER W’ LA KI NAN MY ETHERWALLET PASKE L’ PA NAN MY ETHERWALLET. LI LAKAY OU. NAN BOUS SA W’ TE KREYE SOU SIT NOU AN. ',
...
HELP_14_Title               : '14) KÈK SIT PA AZA ( KONN REKÒMANSE) KREYASYON KLE SEKRÈ A NAN MOUVMAN ANTRE SÒTI YO. KA SA PA POU wallet.2ether.com. KANTITE KREYASYON ALE VINI POU wallet.2ether.com ESKE L’ KONFYAN? ',
HELP_14_Desc_1              : 'MENM KE KANPE MOUVMAN SOURI A ANPIL MOUN JIJE LI GEN ATIRANS , EPI NOU TA KA KONPRANN REZON YO, REYALITE A SE WINDOW.CRYPTO A MEZIRE LIMIT DEZÒD ZIZTÈM PLIS KE MOUVMAN SOURI W’ LA. JAN W’ SÈVI AK MOUVMAN SA YO YO BON MEN NOU(ANSANM AK PLIZYÈ PWOJÈ KRYPTO YO) GEN ANPIL BON REZON POU N’ KWÈ NAN WINDOW.CRYPTO A. ANPLIS, wallet.2ether.com KAPAB SÈVI SOU EKRAN OU KAPAB TOUCHE YO. MEN YON [KONVÈSASYON KI FÈT AK REDDITOR RAGEUR EPI VITALIK BUTERIN SOU MOUVMAN SOURI YO EPI WINDOW.CRYPTO] (https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) EPI MEN  [SPESYAL W3 YO  WINDOW.CRYPTO AN](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto). ',
...
HELP_SecCX_Desc_6           : 'SI NOU TA DWE METE KÒD NAN ENFÒMASYON YO, FÒK OU TA ANTRE YON KÒD SEKRÈ NAN CHAK MOMAN OU BEZWEN WÈ LAJAN SOU KONT OU OSWA LÒT TI NON YO. SI SA NWI W’,NOU MANDE W’ POU SÈVI AK wallet.2ether.com KE EXTENSION CHROME SA. ',
...
HELP_Sec_Desc_4             : 'VERIFYE URL LA – SIT SA SÈVI AK GITHUB EPI OU KAPAB WÈ KÒD SOUS LA LA : : [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) NAN  [https://wallet.2ether.com](https://wallet.2ether.com). ',
