...
/* Onboarding */
ONBOARD_welcome_title           :  'wallet.2ether.com へようこそ!', /*Welcome to wallet.2ether.com*/
...
ONBOARD_whymew_content__6       :  'もし、少し不安だけれども MyEtherWallet を使いたければ、[ハードウェアウォレットを入手しましょう](https://kb.wallet.2ether.com/hardware-wallets/hardware-wallet-recommendations.html)！(英語) あなたの鍵を安全に保管してくれます。', /*If you are scared but want to use MEW, [get a hardware wallet](https://kb.wallet.2ether.com/hardware-wallets/hardware-wallet-recommendations.html)! These keep your keys secure.*/
...
ONBOARD_secure_1_content__3     :  'いつも、必ず、URLが「https://wallet.2ether.com」であるを確認してください。', /*Always check the URL: `https://wallet.2ether.com`.*/
...
ONBOARD_secure_3_content__6     :  '[さらなる安全確保のためのセキュリティ情報はこちら！](https://kb.wallet.2ether.com/getting-started/protecting-yourself-and-your-funds.html)', /*[Even more Security Tips!](https://kb.wallet.2ether.com/getting-started/protecting-yourself-and-your-funds.html)*/
...
ERROR_17                    : '(error_18) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)',
...
ERROR_35                    : '(error_36) 入力したアドレスには、チェックサムが付いていません。<a href="https://kb.wallet.2ether.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer">詳細はこちら</a>',
...
GETH_Balance                : '(geth-01) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)',
GETH_Cheap                  : '(geth-02) ガス価格が低すぎて承認できません。画面右上のドロップダウンメニューから、ガス価格を21 GWEIに上げてみてください。',
GETH_GasLimit               : '(geth-03) ブロックのガスリミットを超過しました。トランザクション・コストが現在のガスリミットを超過しました。 リミット: (d+), 指定: (d+). ガスリミットを21000（送出時）か200000（トークンや契約の送出時）より少なくして、もう一度お試しください。[詳細はこちら](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html)',
GETH_InsufficientFunds      : '(geth-04) 残高が足りません。ガスリミット × ガス価格 + 送出したい量 が現在の残高より多いです。口座にETHを追加するか「残高をすべて送出する」ボタンを使ってください。もしこのエラーが間違いだと思う場合は、 トランザクションを生成しなおしてください。 必要量: (d+), 所持量: (d+) [詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)',
...
GETH_Nonce                  : '(geth-08) トランザクションの[nonce](https://kb.wallet.2ether.com/transactions/what-is-nonce.html)が低すぎます。トランザクション生成ボタンを押してnonceを増やすか、[待機中トランザクションを置き換えてください](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html)。',
GETH_NonExistentAccount     : '(geth-09) アカウントが存在しないか、残高不足です。',

PARITY_AlreadyImported      : "(parity-01) 同じハッシュのトランザクションが既にインポートされています。このトランザクションは既に送出されている可能性があります。トランザクションの重複を防ぐために、[etherscan.io](https://etherscan.io)でアドレスを確認してください。再送出しようとする前に10分間待機してください。[詳しくはこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)",
PARITY_GasLimitExceeded     : "(parity-02) トランザクション・コストが現在のガスリミットを超過しました。 リミット: (d+), 指定: (d+). ガスリミットを21000（送出時）か200000（トークンや契約の送出時）より少なくして、もう一度お試しください。[詳細はこちら](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html)",　　　/* increasing gas limit???  Transaction cost exceeds current gas limit. Limit: (d+), got: (d+). Please lower the gas limit to 21000 (for sending) or 200000 (for sending tokens or contracts) and try again. [Learn More](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html)*/
PARITY_InsufficientBalance  : "(parity-03) 残高が足りません。トランザクションを送出しようとしているアカウントに、十分な量の資金がありません。もしこのエラーが間違いだと思う場合は、「残高をすべて送出する」ボタンを使うか、トランザクションを生成しなおしてください。必要量: (d+), 所持量: (d+) [詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)",
PARITY_InsufficientGasPrice : "(parity-04) 同じnonceのトランザクションが既にキューに存在しているか、トランザクション手数料が低すぎます。トランザクション生成ボタンを押してnonceを増やしてください。[詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)",
PARITY_InvalidGasLimit      : "(parity-05) ガス供給量が制限を超過しています。ガスリミットを21000に下げてください。[詳細はこちら](https://kb.wallet.2ether.com/gas/what-is-gas-ethereum.html)",
PARITY_LimitReached         : "(parity-06) キューに存在するトランザクションの数が多すぎます。上限超過のため、このトランザクションは除外されています。ガス価格を上げてください。[詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)",
PARITY_Old                  : "(parity-07) 同じ[nonce](https://kb.wallet.2ether.com/transactions/what-is-nonce.html)のトランザクションが既に存在しています。トランザクション生成ボタンを押してnonceを増やすか、[待機中トランザクションを置き換えてください](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html)。",
PARITY_TooCheapToReplace    : "(parity-08) トランザクション手数料が低すぎます。ご利用のノードの最低額を満たしていません（最低額: (d+), 指定: (d+)）。ガス価格かガスリミットを上げてください。[詳細はこちら](https://kb.wallet.2ether.com/transactions/transactions-not-showing-or-pending.html)",


FOOTER_1                    : 'Ethereum ウォレットを作成するための、無料で、オープンソースの、クライアントサイド・インターフェイス。Ethereum のブロックチェーンを簡単且つ安全に操作。お財布解錠の前に、URL (wallet.2ether.com) を再確認してください。',
FOOTER_1b                   : '制作者:',
...
NODE_Warning                : 'wallet.2ether.com 経由で接続するためには、HTTPSノードが必要です。[MyEtherWalletをレポジトリからダウンロードして、ローカル環境で実行させて](https://github.com/kvhnuke/etherwallet/releases/latest)、いずれかのノードに接続することもできます。または、無料のSSL証明書を[LetsEncrypt](https://letsencrypt.org/)から入手してください。',
NODE_Name                   : 'ノード名',
NODE_Port                   : 'ノードポート',
...
tx_FoundOnChain_3           : '**何もエラーメッセージが表示されていなければ、トランザクションは正しく送出されました。** ETH/トークンは、送出先に到着しました。もし、ETH/トークンが他のお財布や取引所のウォレットに見つからず、送出から24時間以上経っていたら、[送出先のサービスに連絡](https://kb.wallet.2ether.com/diving-deeper/ethereum-list-of-support-and-communities.html)してください。自分のトランザクションのリンクを連絡し、正確に状況を確認してもらってください。',
...
tx_Summary                  : '繁盛期（ICO実施中など）は、トランザクションは数時間（数日間ではなく）待機中のままになることがあります。このツールは、こういったトランザクションを検索し、「取り消し」または置き換えを行えるようにするためのものです。**これは通常は不要な操作です。このツールに頼るのは本来好ましいことではなく、TXプールが満杯のときのみ効果を発揮します。[このツールに関しては、こちらを参照してください。](https://kb.wallet.2ether.com/transactions/check-status-of-ethereum-transaction.html)**',

TXFEE_Desc                  : 'トランザクション手数料は、トランザクションをブロックへ組み込むためにマイナーに支払われます。`ガスリミット` × `ガス価格`で算出されます。 [GWEI -> ETHの単位変換はこちらからどうぞ](https://wallet.2ether.com/helpers.html)',　/*The TX Fee is paid to miners for including your TX in a block. It is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://wallet.2ether.com/helpers.html)*/

VIEWWALLET_HidePrivKey      : '(隠す)',
VIEWWALLET_ShowPrivKey      : '(表示する)',
VIEWWALLET_Subtitle         : '異なったバージョンの秘密鍵をダウンロードしたり、お財布紙情報（ペーパーウォレット）を再印刷することができます。[Geth/Mistに口座をインポートする](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)際に必要になります。残高を確認するためには、[explorer.2ether.com](https://explorer.2ether.com)のようなブロックチェーン・エクスプローラー サービスを使う事をおすすめします。',
...
HELP_3_Desc_3               : 'Navigate to the wallet.2ether.com "View Wallet Info" page.',
...
HELP_5_Title                : '5) How do I run wallet.2ether.com offline/locally?',
HELP_5_Desc_1               : 'You can run wallet.2ether.com on your computer instead of from the GitHub servers. You can generate a wallet completely offline and send transactions from the "Offline Transaction" page.',
HELP_5_Desc_7               : 'wallet.2ether.com is now running entirely on your computer.',
...
HELP_5_Desc_9               : 'As we are constantly updating wallet.2ether.com, we recommend you periodically update your saved version of the repo.',
...
HELP_8_Desc_2               : 'If wallet.2ether.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of MyEtherWallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site.',
...
HELP_14_Title               : '14) Some sites randomize (seed) the private key generation via mouse movements. wallet.2ether.com doesn\'t do this. Is the random number generation for MyEtherWallet safe?',
HELP_14_Desc_1              : 'While the mouse moving thing is clever and we understand why people like it, the reality is window.crypto ensures more entropy than your mouse movements. The mouse movements aren\'t unsafe, it\'s just that we (and tons of other crypto experiments) believe in window.crypto. In addition, wallet.2ether.com can be used on touch devices. Here\'s a [conversation between an angry redditor and Vitalik Buterin regarding mouse movements v. window.crypto](https://www.reddit.com/r/ethereum/comments/2bilqg/note_there_is_a_paranoid_highsecurity_way_to/cj5sgrm) and here is the [the window.crypto w3 spec](https://dvcs.w3.org/hg/webcrypto-api/raw-file/tip/spec/Overview.html#dfn-GlobalCrypto).',
...
HELP_16_Desc_1              : 'You can use a blockchain explorer like [explorer.2ether.com](https://explorer.2ether.com). Paste your address into the search bar and it will pull up your address and transaction history. For example, here\'s what our [donation account](https://etherscan.io/address/0xDECAF9CD2367cdbb726E904cD6397eDFcAe6068D) looks like on etherscan.io',
...
HELP_Desc                   : 'Do you see something missing? Have another question? [Get in touch with us](mailto:support@wallet.2ether.com), and we will not only answer your question, we will update this page to be more useful to people in the future!',
HELP_Remind_Title           : 'Some reminders',
HELP_Remind_Desc_1          : '**Ethereum, wallet.2ether.com & MyEtherWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost Ether**.',
HELP_Remind_Desc_2          : 'wallet.2ether.com & MyEtherWallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Desc_6           : 'If we were to encrypt these items, you would need to enter a password each time you wanted to view your account balance or view the nicknames. If this concerns you, we recommend you use wallet.2ether.com instead of this Chrome Extension.',
...
HELP_Sec_Desc_4             : 'Check the URL -- This site is being served through GitHub and you can see the source code here: [https://github.com/kvhnuke/etherwallet/tree/gh-pages](https://github.com/kvhnuke/etherwallet/tree/gh-pages) to [https://wallet.2ether.com](https://wallet.2ether.com).',
