...
/* Onboarding */
ONBOARD_welcome_title           :  '欢迎使用 wallet.2ether.com',
...
ONBOARD_blockchain_content__5   :  '当你使用 wallet.2ether.com 查看余额, 或者使用 [etherscan.io](https://etherscan.io)查看交易详细信息时, 这些显示的信息都是直接来自区块链网络, 而不是来自MEW的独立系统.',
...
ONBOARD_whymew_content__6       :  '如果你担心 MEW 还不够安全, [那就赶紧买个硬件钱包吧](https://kb.wallet.2ether.com/hardware-wallets/hardware-wallet-recommendations.html)! 它们能保证你密钥的安全.',
ONBOARD_why_title__alt          :  '但是为啥呢?',
...
ONBOARD_secure_1_content__3     :  '记得每次都要检查 URL 地址: `https://wallet.2ether.com`.',
...
ONBOARD_secure_3_content__6     :  '[点我查看更多安全技巧!](https://kb.wallet.2ether.com/getting-started/protecting-yourself-and-your-funds.html)',
...
/* View Wallet Details */
VIEWWALLET_Subtitle         : '这允许你下载不同格式的私钥和重新打印你的纸钱包。为了将[你的账户导入到Geth/Mist](http://ethereum.stackexchange.com/questions/465/how-to-import-a-plain-private-key-into-geth/)，你可能需要这个操作。如果你想查看你的余额，我们推荐使用区块浏览器，例如[explorer.2ether.com](https://explorer.2ether.com)。 ',
...
ERROR_28                    : '将来使用钱包时，你需要Keystore文件或者私钥。 请做好保存和备份。 如果你没有保存，没有办法恢复钱包。 请阅读[帮助页面](https://wallet.2ether.com/#help)，获得更多信息。 ',
...
ERROR_35                    : 'Input address is not checksummed. <a href="https://kb.wallet.2ether.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer"> More info</a>', // 35
...
TranslatorName_1            : '[ Shaoping@ethfans.org （少平）]((https://wallet.2ether.com/?gaslimit=21000&to=0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740&value=1.0#send-transaction)) ',
TranslatorAddr_1            : '0x4dF5698B1B0195FC44Fe1D2d6037CE33F215c740 ',
/* Translator 1             : Insert Comments Here */
TranslatorName_2            : '[ Wenham@coinwallet.shop (文翰) ]((https://wallet.2ether.com/?gaslimit=21000&to=0x0D2dC3fD9463a7CeBE5f1b946c2D7cF5c3e82127&value=0.1#send-transaction))',
