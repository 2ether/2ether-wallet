...
<div class="col-sm-8">
  ...
  <article class="block" ng-show="wallet.type=='addressOnly'">
    <div class="row form-group">
      ...
      <ul>
        <li class="u__protip">
          <a href="https://kb.wallet.2ether.com/getting-started/accessing-your-new-eth-wallet.html"
             target="_blank"
        ...
        <li class="u__protip">
          <a href="https://kb.wallet.2ether.com/private-keys-passwords/lost-eth-private-key.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://kb.wallet.2ether.com/private-keys-passwords/accessing-different-address-same-private-key-ether.html"
             target="_blank"
             rel="noopener noreferrer"
        ...
        <li class="u__protip">
          <a href="https://kb.wallet.2ether.com/migration/"
             target="_blank"
             rel="noopener noreferrer"
    ...
    <div ng-show="showAdvance || checkTxPage">
      ...
      <section class="row form-group" ng-show="checkTxPage">
        <div class="col-sm-11 clearfix">
          ...
          <a class="account-help-icon"
             href="https://kb.wallet.2ether.com/transactions/what-is-nonce.html"
             target="_blank"
             rel="noopener noreferrer">
            <img src="images/icon-help.svg" class="help-icon" />
