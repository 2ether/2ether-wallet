<main class="tab-pane block--container active"
  ...
  <article class="block__wrap gen__1" ng-show="!wallet && !showGetAddress">
    <section class="block__main gen__1--inner">
      ...
      <div class="text-center">
        <strong>
          <a href="https://kb.wallet.2ether.com/getting-started/creating-a-new-wallet-on-myetherwallet.html"
             target="_blank"
          ...
          &nbsp;&nbsp;&middot;&nbsp;&nbsp;
          <a href="https://kb.wallet.2ether.com/getting-started/getting-started-new.html"
             target="_blank"
             rel="noopener noreferrer"
  ...
  <article role="main" class="block__wrap gen__2" ng-show="wallet && !showPaperWallet" > <!-- -->
    ...
    <section class="block__help">
      ...
      <ul>
        <li>
          <a href="https://kb.wallet.2ether.com/getting-started/backing-up-your-new-wallet.html" target="_blank" rel="noopener noreferrer">
        ...
        <li>
          <a href="https://kb.wallet.2ether.com/private-keys-passwords/difference-beween-private-key-and-keystore-file.html" target="_blank" rel="noopener noreferrer">
  ...
  <article role="main" class="block__wrap gen__3" ng-show="showPaperWallet">
    ...
    <section class="block__help">
      ...
      <ul>
        <li><a href="https://kb.wallet.2ether.com/getting-started/backing-up-your-new-wallet.html" target="_blank" rel="noopener noreferrer">
          <strong translate="HELP_2a_Title">
            How to Save & Backup Your Wallet.
          </strong>
        </a></li>
        <li><a href="https://kb.wallet.2ether.com/getting-started/protecting-yourself-and-your-funds.html" target="_blank" rel="noopener noreferrer">
          <strong translate="GEN_Help_15">Preventing loss &amp; theft of your funds.</strong>
        </a></li>
        <li><a href="https://kb.wallet.2ether.com/private-keys-passwords/difference-beween-private-key-and-keystore-file.html" target="_blank" rel="noopener noreferrer">
      ...
      <ul>
        ...
        <li>
          <a href="https://kb.wallet.2ether.com/offline/ethereum-cold-storage-with-myetherwallet.html" target="_blank" rel="noopener noreferrer" translate="GEN_Help_20">Cold Storage</a>
        </li>
      </ul>
